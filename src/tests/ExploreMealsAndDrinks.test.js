...
describe('Testa pagina de explorar', () => {
  ...
  test('ao clicar no botao de ingredientes redireciona corretamente', () => {
  ...
  test('ao clicar no botao de origem redireciona corretamente', () => {
    const { history } = renderWithRouter(
      <HeaderContextProvider>
        <SearchBarContextProvider>
          <ExplorerRecipe />
  ...
  test('ao clicar no botao de surpresa redireciona corretamente', async () => {
    const { history } = renderWithRouter(
      <HeaderContextProvider>
        <SearchBarContextProvider>
          <ExplorerRecipe />
    ...
    await expect(mockRecipeApi).toHaveBeenCalledWith('comidas');
